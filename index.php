						...
						<div id="itemDetailsTab" class="container-fluid tab-pane active">
							...
							<!--	<div class="form-group col-md-3">
							  ...
							  <div class="form-row">
								...
								<div class="form-group col-md-3">
								  <label for="itemDetailsMetrics">Metrics<span class="requiredIcon">*</span></label>
								  <input type="text" class="form-control" value="0" name="itemDetailsMetrics" id="itemDetailsMetrics">
								</div>
								<div class="form-group col-md-3">
